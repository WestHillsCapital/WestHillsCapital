export default function LogoDDark() {
  return (
    <div style={{
      ...
      {/* Wordmark row — dark logo on dark bg */}
      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        <svg width="40" height="40" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Navy body with white stroke to pop on dark bg */}
          <path d="M6 4h18l6 6v22H6V4z" fill="#0E1D4A" stroke="white" strokeWidth="1.5" strokeLinejoin="round" />
          <path d="M24 4l6 6h-6V4z" fill="#C49A38" />
          <rect x="10" y="14" width="10" height="1.5" rx="0.75" fill="white" opacity="0.6" />
          <rect x="10" y="18" width="14" height="1.5" rx="0.75" fill="white" opacity="0.6" />
          <rect x="10" y="22" width="8" height="1.5" rx="0.75" fill="white" opacity="0.6" />
