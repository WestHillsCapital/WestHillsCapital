...
export const CUSTODIAN_FEES: CustodianFees[] = [
  ...
  },
  {
    ...
    verificationStatus: "unverified",
    verifiedDate: null,
    feesUrl: "https://www.midlandira.com/fees/",
    setupFee: null,
    setupFeeNotes: "Needs verification.",
    annualFee: {
      structure: "asset-based",
      tiers: [],
      notes: "Needs verification — Midland IRA may use asset-based or tiered annual fees.",
    },
    storageFees: [
      {
        type: "flat",
        annualRate: null,
        notes: "Needs verification — storage billed through designated depository.",
      },
    ],
    transactionFee: null,
    transactionFeeNotes: "Needs verification.",
    ...
    distributionFee: null,
    otherFees: [],
    summaryNotes: "UNVERIFIED — all fields must be confirmed with Midland IRA before publishing.",
  },
  {
    slug: "advanta-ira",
    name: "Advanta IRA",
