...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Auto-fill from another field", detail: "In the field editor, expand 'Auto-fill from another field when' to configure a copy trigger: choose the source field (the field to copy from), the trigger field (whose answer activates the copy), and the trigger value. When the trigger condition is met during the interview, the value copies automatically. Example: when 'Beneficiary Relationship' equals 'Spouse', the beneficiary address fields auto-populate from the primary account holder address fields. The copied value can still be edited by the user." },
    ],
  },
  {
    id: "validation",
