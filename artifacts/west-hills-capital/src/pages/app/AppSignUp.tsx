...
const appearance = {
  ...
  elements: {
    ...
    footerActionLink: "!text-[#1B4FD8] font-semibold hover:!text-[#1640B0]",
    ...
    formButtonPrimary: "!bg-[#1B4FD8] hover:!bg-[#1640B0] !text-white !font-semibold !shadow-none",
    formFieldInput: "border-gray-200 bg-gray-50 focus:border-[#1B4FD8] focus:ring-[#1B4FD8]",
