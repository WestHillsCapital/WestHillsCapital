...
function SubmissionBankSection({ getAuthHeaders }: { getAuthHeaders: () => HeadersInit }) {
...
function BillingSection({ getAuthHeaders }: { getAuthHeaders: () => HeadersInit }) {
  ...
  const PLAN_MONTHLY = { starter: 49, pro: 249, enterprise: 3000 } as const;
      ...
      <div className="lg:flex lg:gap-10 lg:items-start">
        ...
        <aside className="hidden lg:block w-44 shrink-0 sticky top-[72px] self-start">
          ...
          <button
            ...
            className="mt-6 w-full rounded-lg px-3 py-1.5 text-sm font-medium transition-opacity flex items-center gap-1.5 opacity-70 hover:opacity-100"
            style={{
              backgroundColor: /^#[0-9a-fA-F]{6}$/.test(brandColor) ? brandColor : "#C49A38",
              color: getTextForBg(/^#[0-9a-fA-F]{6}$/.test(brandColor) ? brandColor : "#C49A38"),
            }}
