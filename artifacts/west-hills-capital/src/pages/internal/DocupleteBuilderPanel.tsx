            ...
            <div className="flex flex-col items-center justify-center py-14 px-6 text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-white border border-[#E2E8F0] hover:border-[#C49A38] hover:text-[#0F1C3F] text-[#6B7A99] text-sm font-medium rounded-lg px-5 py-2.5 transition-colors"
                >
              ...
              <div className="space-y-4 max-w-[1200px]">
                <div className="rounded-lg bg-white p-4 space-y-4 shadow-[0_1px_3px_0_rgba(0,0,0,0.05),0_1px_2px_0_rgba(0,0,0,0.03)]">
                    ...
                    {inlineAddGroupOpen && (
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="flex-1 border border-[#E2E8F0] rounded px-2 py-1.5 text-xs focus:outline-none focus:border-[#C49A38]"
                        />
                        <button
                          type="button"
                  ...
                  <div>
                    ...
                    <div className="min-h-[36px] max-h-28 flex flex-wrap gap-1.5 content-start p-2 border border-[#E2E8F0] rounded overflow-y-auto cursor-text focus-within:border-[#C49A38] transition-colors">
                      <TagChipInput
                ...
                {selectedPackage.documents.length === 0 ? (
                  <div className="grid gap-5" style={{ gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", alignContent: "start" }}>
                    <button
                      type="button"
                      onClick={addDocument}
                      className="rounded-lg border-2 border-dashed border-[#E2E8F0] bg-white hover:border-[#C49A38] hover:bg-[#EFF6FF] transition flex flex-col items-center justify-center gap-2 min-h-[160px] text-[#8A9BB8] hover:text-[#C49A38] cursor-pointer"
                    >
                  ...
                  >
                    <div className="grid gap-5" style={{ gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", alignContent: "start" }}>
                          ...
                          <SortableItem key={doc.id} id={doc.id}>
                            {({ handleProps, wrapperRef, wrapperStyle, isDragging }) => (
                              <div
                                ...
                                style={wrapperStyle}
                                {...handleProps}
                                className={`relative rounded-lg border bg-white flex flex-col transition-shadow cursor-grab active:cursor-grabbing select-none ${isDragging ? "opacity-40 shadow-2xl scale-95" : "hover:shadow-md"} ${selectedDocument?.id === doc.id ? "border-[#C49A38] ring-2 ring-[#C49A38]/20" : "border-[#E2E8F0]"}`}
                              >
                      ...
                      <button
                        type="button"
                        onClick={addDocument}
                        className="rounded-lg border-2 border-dashed border-[#E2E8F0] bg-white hover:border-[#C49A38] hover:bg-[#EFF6FF] transition flex flex-col items-center justify-center gap-2 min-h-[120px] text-[#8A9BB8] hover:text-[#C49A38] cursor-pointer"
                      >
                        <span className="text-2xl font-light leading-none">+</span>
                        <span className="text-[11px] font-medium">Add Placeholder</span>
                      </button>
                    ...
                    <div>
                      <div className="flex items-center justify-between">
                        ...
                        {packageInterviewFields.length > 1 && (
                          <button type="button" onClick={() => goBuilderStep("interview", { autoSort: true })} className="text-xs text-[#6B7A99] border border-[#E2E8F0] rounded px-2 py-1 hover:border-[#C49A38] hover:text-[#C49A38] transition-colors bg-[#ffffff]">Sort by PDF order</button>
                        )}
                      </div>
                          ...
                          <SortableContext items={packageInterviewFields.map((f) => f.id)} strategy={verticalListSortingStrategy}>
                            <div className="space-y-1">
                              ...
                              <div
                                ...
                                style={wrapperStyle}
                                {...handleProps}
                                className={`rounded-xl border p-3 flex flex-col gap-1.5 transition-shadow cursor-grab active:cursor-grabbing select-none ${isDragging ? "opacity-40 shadow-lg border-[#C49A38] bg-[#F1F5F9]" : "border-gray-200 bg-white shadow-sm"}`}
                              >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-3 max-w-[1200px] items-stretch">
                      <div className="rounded-lg border-2 border-[#0E1D4A] bg-white p-3 min-h-[100px] flex flex-col">
                        <div className="flex items-start gap-2 mb-1.5">
                          <svg className="w-4 h-4 text-[#0E1D4A] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" /></svg>
                      ...
                      <button type="button" onClick={() => updateSelectedPackage((pkg) => ({ ...pkg, enable_interview: !pkg.enable_interview }))} className={`text-left rounded-lg border-2 p-3 transition-colors min-h-[100px] flex flex-col ${selectedPackage.enable_interview ? "border-[#0F1C3F] bg-white" : "border-gray-200 bg-gray-50"}`}>
                        <div className="flex items-start gap-2 mb-1.5">
                          ...
                          <span className={`ml-auto text-[10px] rounded px-1.5 py-0.5 shrink-0 border ${selectedPackage.enable_interview ? "bg-[#EAF0FB] text-[#0F1C3F] border-[#0F1C3F]/20" : "bg-gray-100 text-gray-400 border-gray-200"}`}>{selectedPackage.enable_interview ? "Enabled" : "Off"}</span>
                        </div>
                        <p className="text-xs text-[#6B7A99]">Staff can launch guided interviews from the Interviews tab and Deal Builder.</p>
                      </button>
                      <button type="button" onClick={() => updateSelectedPackage((pkg) => ({ ...pkg, enable_csv: !pkg.enable_csv }))} className={`text-left rounded-lg border-2 p-3 transition-colors min-h-[100px] flex flex-col ${selectedPackage.enable_csv ? "border-[#0F1C3F] bg-white" : "border-gray-200 bg-gray-50"}`}>
                        <div className="flex items-start gap-2 mb-1.5">
                          ...
                          <span className={`ml-auto text-[10px] rounded px-1.5 py-0.5 shrink-0 border ${selectedPackage.enable_csv ? "bg-[#EAF0FB] text-[#0F1C3F] border-[#0F1C3F]/20" : "bg-gray-100 text-gray-400 border-gray-200"}`}>{selectedPackage.enable_csv ? "Enabled" : "Off"}</span>
                        </div>
                        <p className="text-xs text-[#6B7A99]">Upload a spreadsheet of clients — Docuplete generates one PDF packet per row.</p>
                      </button>
                      <button type="button" onClick={() => updateSelectedPackage((pkg) => ({ ...pkg, require_preview: !pkg.require_preview }))} className={`text-left rounded-lg border-2 p-3 transition-colors min-h-[100px] flex flex-col ${selectedPackage.require_preview ? "border-[#0F1C3F] bg-white" : "border-gray-200 bg-gray-50"}`}>
                        <div className="flex items-start gap-2 mb-1.5">
                          ...
                          <span className={`ml-auto text-[10px] rounded px-1.5 py-0.5 shrink-0 border ${selectedPackage.require_preview ? "bg-[#EAF0FB] text-[#0F1C3F] border-[#0F1C3F]/20" : "bg-gray-100 text-gray-400 border-gray-200"}`}>{selectedPackage.require_preview ? "Required" : "Off"}</span>
                        </div>
                      ...
                      <button type="button" onClick={() => updateSelectedPackage((pkg) => ({ ...pkg, require_scroll_confirmation: !pkg.require_scroll_confirmation }))} className={`text-left rounded-lg border-2 p-3 transition-colors min-h-[100px] flex flex-col ${selectedPackage.require_scroll_confirmation ? "border-[#0F1C3F] bg-white" : "border-gray-200 bg-gray-50"}`}>
                        <div className="flex items-start gap-2 mb-1.5">
                          ...
                          <span className={`ml-auto text-[10px] rounded px-1.5 py-0.5 shrink-0 border ${selectedPackage.require_scroll_confirmation ? "bg-[#EAF0FB] text-[#0F1C3F] border-[#0F1C3F]/20" : "bg-gray-100 text-gray-400 border-gray-200"}`}>{selectedPackage.require_scroll_confirmation ? "Required" : "Off"}</span>
                        </div>
                      ...
                      <button type="button" onClick={() => updateSelectedPackage((pkg) => ({ ...pkg, enable_customer_link: !pkg.enable_customer_link }))} className={`text-left rounded-lg border-2 p-3 transition-colors min-h-[100px] flex flex-col ${selectedPackage.enable_customer_link ? "border-[#0F1C3F] bg-white" : "border-gray-200 bg-gray-50"}`}>
                        <div className="flex items-start gap-2 mb-1.5">
                          ...
                          <span className={`ml-auto text-[10px] rounded px-1.5 py-0.5 shrink-0 border ${selectedPackage.enable_customer_link ? "bg-[#EAF0FB] text-[#0F1C3F] border-[#0F1C3F]/20" : "bg-gray-100 text-gray-400 border-gray-200"}`}>{selectedPackage.enable_customer_link ? "Enabled" : "Off"}</span>
                        </div>
                      ...
                      <div className={`rounded-lg border-2 p-3 transition-colors min-h-[100px] flex flex-col ${selectedPackage.webhook_enabled ? "border-[#0F1C3F] bg-white" : "border-gray-200 bg-gray-50"}`}>
                        <button
                          type="button"
                          onClick={() => {
                        ...
                        >
                          <div className="flex items-start gap-2 mb-1.5">
                            ...
                            <span className={`ml-auto text-[10px] rounded px-1.5 py-0.5 shrink-0 border ${selectedPackage.webhook_enabled ? "bg-[#EAF0FB] text-[#0F1C3F] border-[#0F1C3F]/20" : "bg-gray-100 text-gray-400 border-gray-200"}`}>{selectedPackage.webhook_enabled ? "Enabled" : "Off"}</span>
                          </div>
                                    ...
                                    return (
                                      <div key={d.id} className="bg-white border border-[#E2E8F0] rounded px-2 py-1.5">
                                        ...
                                        {isExpanded && d.response_body && (
                                          <pre className="mt-1.5 text-[9px] font-mono text-[#6B7A99] bg-gray-50 rounded p-1.5 overflow-x-auto whitespace-pre-wrap break-all max-h-20 overflow-y-auto">{d.response_body}</pre>
                                        )}
                                      </div>
                                    );
                                  })}
                      ...
                      <div className={`rounded-lg border-2 p-3 transition-colors ${selectedPackage.slack_notifications_enabled ? "border-[#0F1C3F] bg-white" : "border-gray-200 bg-gray-50"}`}>
                        <button type="button" onClick={() => updateSelectedPackage((pkg) => ({ ...pkg, slack_notifications_enabled: !pkg.slack_notifications_enabled }))} className="w-full text-left">
                          <div className="flex items-center gap-2 mb-1.5">
                            ...
                            <span className={`ml-auto text-[10px] rounded px-1.5 py-0.5 shrink-0 border ${selectedPackage.slack_notifications_enabled ? "bg-[#EAF0FB] text-[#0F1C3F] border-[#0F1C3F]/20" : "bg-gray-100 text-gray-400 border-gray-200"}`}>{selectedPackage.slack_notifications_enabled ? "Enabled" : "Off"}</span>
                          </div>
                      ...
                      <button type="button" onClick={() => updateSelectedPackage((pkg) => ({ ...pkg, notify_staff_on_submit: !pkg.notify_staff_on_submit }))} className={`text-left rounded-lg border-2 p-3 transition-colors ${selectedPackage.notify_staff_on_submit ? "border-[#0F1C3F] bg-white" : "border-gray-200 bg-gray-50"}`}>
                        <div className="flex items-center gap-2 mb-1.5">
                          ...
                          <span className={`ml-auto text-[10px] rounded px-1.5 py-0.5 shrink-0 border ${selectedPackage.notify_staff_on_submit ? "bg-[#EAF0FB] text-[#0F1C3F] border-[#0F1C3F]/20" : "bg-gray-100 text-gray-400 border-gray-200"}`}>{selectedPackage.notify_staff_on_submit ? "Enabled" : "Off"}</span>
                        </div>
                        <p className="text-xs text-[#6B7A99]">Email all account staff when a client submits an interview.</p>
                      </button>
                      <button type="button" onClick={() => updateSelectedPackage((pkg) => ({ ...pkg, notify_client_on_submit: !pkg.notify_client_on_submit }))} className={`text-left rounded-lg border-2 p-3 transition-colors ${selectedPackage.notify_client_on_submit ? "border-[#0F1C3F] bg-white" : "border-gray-200 bg-gray-50"}`}>
                        <div className="flex items-center gap-2 mb-1.5">
                          ...
                          <span className={`ml-auto text-[10px] rounded px-1.5 py-0.5 shrink-0 border ${selectedPackage.notify_client_on_submit ? "bg-[#EAF0FB] text-[#0F1C3F] border-[#0F1C3F]/20" : "bg-gray-100 text-gray-400 border-gray-200"}`}>{selectedPackage.notify_client_on_submit ? "Enabled" : "Off"}</span>
                        </div>
                        <p className="text-xs text-[#6B7A99]">Send the client a branded receipt email after they submit.</p>
                      </button>
                      <div className={`rounded-lg border-2 p-3 transition-colors ${selectedPackage.enable_embed ? "border-[#0F1C3F] bg-white" : "border-gray-200 bg-gray-50"}`}>
                        <button type="button" className="w-full text-left" onClick={() => updateSelectedPackage((pkg) => ({ ...pkg, enable_embed: !pkg.enable_embed }))}>
                          <div className="flex items-center gap-2 mb-1.5">
                            ...
                            <span className={`ml-auto text-[10px] rounded px-1.5 py-0.5 shrink-0 border ${selectedPackage.enable_embed ? "bg-[#EAF0FB] text-[#0F1C3F] border-[#0F1C3F]/20" : "bg-gray-100 text-gray-400 border-gray-200"}`}>{selectedPackage.enable_embed ? "Enabled" : "Off"}</span>
                          </div>
