  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: 'radial-gradient(ellipse 50% 50% at 50% 50%, #10B98115, transparent)' }}
      />
      ...
      <div className="flex gap-16 items-center w-full max-w-5xl">
        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden relative">
            <div className="px-5 py-4" style={{ backgroundColor: '#1B4FD8' }}>
              <div className="text-white font-bold text-sm" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Client Document Package</div>
              <div className="text-white/60 text-xs" style={{ fontFamily: "'DM Sans', sans-serif" }}>Thomas Mitchell · 6 documents</div>
            </div>
            <div className="p-5 space-y-3">
              {['Account Application', 'Suitability Form', 'Risk Profile', 'Beneficiary Designation', 'Transfer Auth', 'Compliance Disclosure'].map((name, i) => (
                ...
                >
                  ...
                  <span className="text-xs text-gray-600" style={{ fontFamily: "'DM Sans', sans-serif" }}>{name}</span>
                </motion.div>
              ))}
            </div>
            ...
            >
              <span className="text-green-500 font-black text-xs leading-none" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>SEALED</span>
              <span className="text-green-400 text-[8px] mt-0.5" style={{ fontFamily: "'JetBrains Mono', monospace" }}>PDF</span>
            </motion.div>
          </div>
        </motion.div>
        ...
        <div className="flex-1">
          <motion.h2
            className="text-[3.5vw] font-black text-white leading-tight mb-8"
          ...
          >
            ...
            <span style={{ color: '#1B4FD8' }}>Docuplete.</span>
          </motion.h2>
          ...
          <div className="space-y-4 mb-8">
            {BENEFITS.map((b, i) => (
              ...
              >
                ...
                <span className="text-white/80 text-lg" style={{ fontFamily: "'DM Sans', sans-serif" }}>{b.text}</span>
              </motion.div>
            ))}
          </div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <img src={`${import.meta.env.BASE_URL}images/sally.png`} className="w-12 h-12 rounded-full object-cover border-2" style={{ borderColor: '#1B4FD8' }} />
            <img src={`${import.meta.env.BASE_URL}images/tom.png`} className="w-12 h-12 rounded-full object-cover border-2 -ml-4" style={{ borderColor: '#C49A38' }} />
            <p className="text-white/70 text-sm ml-2" style={{ fontFamily: "'DM Sans', sans-serif" }}>
