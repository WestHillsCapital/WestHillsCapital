  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-[2.5vw] font-black text-white tracking-tight" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Docuplete</span>
      </motion.div>
      ...
      <motion.p
        className="text-white/50 text-xl text-center max-w-lg"
        style={{ fontFamily: "'DM Sans', sans-serif", filter: 'blur(0px)' }}
      ...
      >
        {['Financial Services', 'Insurance', 'Real Estate', 'Legal', 'Healthcare'].map((tag, i) => (
          <motion.span
            key={tag}
            className="px-4 py-2 rounded-full border border-white/15 text-white/50 text-sm"
      ...
      <motion.p
        className="text-lg mt-10 tracking-wide"
