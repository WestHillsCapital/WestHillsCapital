    ...
    <div className="flex items-center gap-3">
      ...
      <div className="w-9 h-9 shrink-0">
        <svg viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          <path d="M6 4h18l6 6v22H6V4z" fill={light ? "white" : "#0E1D4A"} />
          <path d="M24 4l6 6h-6V4z" fill="#C49A38" />
          <rect x="10" y="14" width="10" height="1.5" rx="0.75" fill={light ? "rgba(11,18,32,0.3)" : "rgba(255,255,255,0.5)"} />
          <rect x="10" y="18" width="14" height="1.5" rx="0.75" fill={light ? "rgba(11,18,32,0.3)" : "rgba(255,255,255,0.5)"} />
          <rect x="10" y="22" width="8" height="1.5" rx="0.75" fill={light ? "rgba(11,18,32,0.3)" : "rgba(255,255,255,0.5)"} />
      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-white/90 backdrop-blur border-b border-[#E8EDF5]">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="https://docs.docuplete.com" className="hidden sm:block text-sm text-[#4B5A7A] hover:text-[#0B1220] transition-colors">Docs</a>
            <a
              href={NAV_SIGNUP}
...
// → send link, done.`}</pre>
          ...
          <div className="border border-white/10 bg-white/5 rounded-2xl p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              <a
                href="https://docuplete.app/sandbox"
