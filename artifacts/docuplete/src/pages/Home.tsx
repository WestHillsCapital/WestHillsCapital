      ...
      <section className="bg-[#F5F7FC] border-y border-[#E8EDF5] py-5 px-6">
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-center gap-x-10 gap-y-3 text-sm text-[#4B5A7A]">
          <span className="flex items-center gap-2">
            ...
            Recognized on the <strong className="text-[#0B1220] font-semibold">Inc. 500</strong>
          </span>
          ...
          <div className="grid sm:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold text-[#0B1220] mb-4">
                The numbers that made Inc. 500.
              </h2>
              <p className="text-[#4B5A7A] leading-relaxed">
                An early version of Docuplete helped power one of the fastest-growing financial services firms in the country — ranked <strong className="text-[#0B1220]">#79 on the Inc. 500</strong>. The same process that drove that growth is now available to your team.
              </p>
            </div>
