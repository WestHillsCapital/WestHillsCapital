  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        >
          <h2 className="text-[5vw] font-display font-black text-white leading-none">
            High chance of
          </h2>
          <h2 className="text-[5vw] font-display font-black leading-none" style={{ color: '#EF4444' }}>
            mistakes.
          </h2>
        </motion.div>

        {/* Error badges floating around */}
        <div className="relative w-full h-48">
          {ERRORS.map((err, i) => (
            <motion.div
              key={err.text}
              className="absolute bg-red-500/90 text-white text-xs font-mono px-3 py-1.5 rounded-full border border-red-400/60 shadow-lg"
      ...
      >
        ...
        <p className="text-[var(--color-accent)] font-display font-bold text-right mt-2">— Tom</p>
      </motion.div>
    </motion.div>
  );
}
