...
const FINANCIAL_SERVICES_FIELDS: SeedField[] = [
  ...
  { id: "fs_portfolio_value",              label: "Portfolio value ($)",               category: "Financial profile",   field_type: "text",     source: "portfolioValue",             sensitive: true,  required: false, validation_type: "currency", options: [], sort_order: 220 },
  { id: "fs_annual_income",                label: "Annual income ($)",                 category: "Financial profile",   field_type: "text",     source: "annualIncome",               sensitive: true,  required: false, validation_type: "currency", options: [], sort_order: 230 },
  { id: "fs_net_worth",                    label: "Net worth ($)",                     category: "Financial profile",   field_type: "text",     source: "netWorth",                   sensitive: true,  required: false, validation_type: "currency", options: [], sort_order: 240 },
  { id: "fs_liquid_net_worth",             label: "Liquid net worth ($)",              category: "Financial profile",   field_type: "text",     source: "liquidNetWorth",             sensitive: true,  required: false, validation_type: "currency", options: [], sort_order: 250 },
  ...
  { id: "fs_contribution_amount",          label: "Contribution amount ($)",           category: "Transaction",         field_type: "text",     source: "contributionAmount",         sensitive: false, required: false, validation_type: "currency", options: [], sort_order: 420 },
  { id: "fs_withdrawal_amount",            label: "Withdrawal amount ($)",             category: "Transaction",         field_type: "text",     source: "withdrawalAmount",           sensitive: false, required: false, validation_type: "currency", options: [], sort_order: 430 },
...
const INSURANCE_FIELDS: SeedField[] = [
  ...
  { id: "ins_coverage_amount",             label: "Coverage amount ($)",               category: "Policy",              field_type: "text",     source: "coverageAmount",             sensitive: false, required: false, validation_type: "currency", options: [], sort_order: 220 },
  { id: "ins_premium_amount",              label: "Premium amount ($)",                category: "Policy",              field_type: "text",     source: "premiumAmount",              sensitive: false, required: false, validation_type: "currency", options: [], sort_order: 230 },
  ...
  { id: "ins_primary_beneficiary_pct",     label: "Primary beneficiary percentage (%)", category: "Beneficiary",       field_type: "text",     source: "primaryBeneficiaryPct",      sensitive: false, required: false, validation_type: "percent", options: [], sort_order: 340 },
  ...
  { id: "ins_contingent_beneficiary_pct",  label: "Contingent beneficiary percentage (%)", category: "Beneficiary",   field_type: "text",     source: "contingentBeneficiaryPct",   sensitive: false, required: false, validation_type: "percent", options: [], sort_order: 360 },
  ...
  { id: "ins_deductible_amount",           label: "Deductible amount ($)",             category: "Health coverage",     field_type: "text",     source: "deductibleAmount",           sensitive: false, required: false, validation_type: "currency", options: [], sort_order: 410 },
...
const REAL_ESTATE_FIELDS: SeedField[] = [
  ...
  { id: "re_purchase_price",               label: "Purchase price ($)",                category: "Transaction",         field_type: "text",     source: "purchasePrice",              sensitive: false, required: true,  validation_type: "currency", options: [], sort_order: 260 },
  { id: "re_down_payment_amount",          label: "Down payment amount ($)",           category: "Transaction",         field_type: "text",     source: "downPaymentAmount",          sensitive: false, required: false, validation_type: "currency", options: [], sort_order: 270 },
  { id: "re_loan_amount",                  label: "Loan amount ($)",                   category: "Transaction",         field_type: "text",     source: "loanAmount",                 sensitive: false, required: false, validation_type: "currency", options: [], sort_order: 280 },
  { id: "re_earnest_money_amount",         label: "Earnest money deposit ($)",         category: "Transaction",         field_type: "text",     source: "earnestMoneyAmount",         sensitive: false, required: false, validation_type: "currency", options: [], sort_order: 290 },
  ...
  { id: "re_commission_percentage",        label: "Commission percentage (%)",         category: "Agents",              field_type: "text",     source: "commissionPercentage",       sensitive: false, required: false, validation_type: "percent", options: [], sort_order: 380 },
  ...
  { id: "re_appraisal_value",              label: "Appraised value ($)",               category: "Due diligence",       field_type: "text",     source: "appraisalValue",             sensitive: false, required: false, validation_type: "currency", options: [], sort_order: 420 },
  ...
  { id: "re_hoa_monthly_fee",              label: "HOA monthly fee ($)",               category: "HOA",                 field_type: "text",     source: "hoaMonthlyFee",              sensitive: false, required: false, validation_type: "currency", options: [], sort_order: 440 },
];
...
const LEGAL_FIELDS: SeedField[] = [
  ...
  { id: "leg_retainer_amount",             label: "Retainer amount ($)",               category: "Billing",             field_type: "text",     source: "retainerAmount",             sensitive: false, required: false, validation_type: "currency", options: [], sort_order: 300 },
  { id: "leg_hourly_rate",                 label: "Hourly rate ($/hr)",                category: "Billing",             field_type: "text",     source: "hourlyRate",                 sensitive: false, required: false, validation_type: "currency", options: [], sort_order: 310 },
  ...
  { id: "leg_estate_value",                label: "Estate gross value ($)",            category: "Estate planning",     field_type: "text",     source: "estateValue",                sensitive: true,  required: false, validation_type: "currency", options: [], sort_order: 390 },
...
const GENERAL_FIELDS: SeedField[] = [
  { id: "gen_full_name",                   label: "Full name",                         category: "Contact",             field_type: "text",     source: "fullName",                   sensitive: false, required: true,  validation_type: "name",     options: [], sort_order: 100 },
  { id: "gen_email",                       label: "Email address",                     category: "Contact",             field_type: "text",     source: "email",                      sensitive: false, required: true,  validation_type: "email",    options: [], sort_order: 110 },
  { id: "gen_phone",                       label: "Phone number",                      category: "Contact",             field_type: "text",     source: "phone",                      sensitive: false, required: false, validation_type: "phone",    options: [], sort_order: 120 },
  { id: "gen_street_address",              label: "Street address",                    category: "Address",             field_type: "text",     source: "streetAddress",              sensitive: false, required: false, validation_type: "none",     options: [], sort_order: 130 },
  { id: "gen_city",                        label: "City",                              category: "Address",             field_type: "text",     source: "city",                       sensitive: false, required: false, validation_type: "none",     options: [], sort_order: 140 },
  { id: "gen_state",                       label: "State",                             category: "Address",             field_type: "text",     source: "state",                      sensitive: false, required: false, validation_type: "none",     options: [], sort_order: 150 },
  { id: "gen_zip_code",                    label: "ZIP code",                          category: "Address",             field_type: "text",     source: "zipCode",                    sensitive: false, required: false, validation_type: "zip",      options: [], sort_order: 160 },
  { id: "gen_date",                        label: "Date",                              category: "Document",            field_type: "date",     source: "date",                       sensitive: false, required: false, validation_type: "date",     options: [], sort_order: 170 },
  { id: "gen_signature_line",              label: "Signature line",                    category: "Document",            field_type: "text",     source: "signatureLine",              sensitive: false, required: false, validation_type: "name",     options: [], sort_order: 180 },
  { id: "gen_date_of_birth",               label: "Date of birth",                     category: "Identity",            field_type: "date",     source: "dateOfBirth",                sensitive: true,  required: false, validation_type: "date",     options: [], sort_order: 190 },
  { id: "gen_ssn",                         label: "Social Security Number",            category: "Identity",            field_type: "text",     source: "ssn",                        sensitive: true,  required: false, validation_type: "ssn",      options: [], sort_order: 195 },
  { id: "gen_company_name",                label: "Company / organization name",       category: "Contact",             field_type: "text",     source: "companyName",                sensitive: false, required: false, validation_type: "none",     options: [], sort_order: 200 },
];
