    ...
    schemas: {
      ...
      DocuFillSessionListItem: {
        ...
        properties: {
          ...
          answers:             { type: "object", additionalProperties: true, description: "Client answers keyed by field ID. Sensitive fields are not redacted here (use the webhook payload for redacted answers)." },
          prefill:             { type: "object", additionalProperties: true, description: "Prefill values supplied when the session was created." },
          generated_pdf_url:   { type: "string", nullable: true, description: "Relative URL to download the generated PDF. Only present when status is `generated`." },
          created_at:          { type: "string", format: "date-time" },
          updated_at:          { type: "string", format: "date-time" },
