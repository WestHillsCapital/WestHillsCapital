...
export interface paths {
    ...
    "/sessions": {
        ...
        put?: never;
        /**
         * Create a headless interview session
         * @description Creates a new Docuplete interview session programmatically.
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        packageId: number;
                        /**
                         * @description Optional map of field source keys → values to pre-populate
                        ...
                        /**
                         * @description Days until the interview link expires (1–3650).
                         ...
                         * @enum {string}
                         */
                        locale?: "en" | "es" | "fr" | "de" | "pt" | "zh" | "ja" | "ko" | "ar";
                    };
                };
            };
            responses: {
